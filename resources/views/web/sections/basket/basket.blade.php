            ...
            @if ($productsInCart)
                ...
                <div class="row border-top rounded mt-3">
                    <div class="product-cart--name">
                        <a href="/catalog/products/{{ $product->id }}"><span>{{ $product->name }}</span>
                        </a>
                    </div>
                        ...
                        <div class="product-cart--body">
                            ...
                            <div class="product-cart--discription">
                                <table class="product-cart--elements table">
                                    <tr>
                                        <td>Артикул:</td>
                                        <td name="articl" id="articl_product">{{ $product->code }}</td>
                                    </tr>
                                    <tr>
                                        <td>Размер:</td>
                                        <td name="size">L</td>
                    ...
                    <div class="col-3 col-lg-2">
                        <div class="product-cart--quantity">
                            ...
                            <input class="quntity--value" value="{{ $productsInCart[$product->id] }}" size="1" >
                            <button class="quantity-plus quantity-btn"></button>
                        </div>
                    </div>
                    <div class="col-4 col-lg-2">
                        <div class="product-cart--summ">{{ $product->price * $productsInCart[$product->id] }}</div>
                    </div>
                    <div class="col-lg-12">
                        <div class="product-delete"><a href="cart/delete/{{ $product->id }}" onclick="delCart()"><u>Удалить</u></a></div>
                    </div>
                </div>
                @endforeach
